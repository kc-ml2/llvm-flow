...
15:                                               ; preds = %31, %14
  ...
  br i1 %18, label %19, label %34, !dbg !105
...
31:                                               ; preds = %19
  %32 = load i32, i32* %4, align 4, !dbg !119
  %33 = add nsw i32 %32, 1, !dbg !119
  store i32 %33, i32* %4, align 4, !dbg !119
  br label %15, !dbg !120, !llvm.loop !121

34:                                               ; preds = %15
  %35 = load %struct._IO_FILE*, %struct._IO_FILE** %6, align 8, !dbg !123
  %36 = call i32 @fclose(%struct._IO_FILE* %35), !dbg !124
  ret i32 0, !dbg !125
}
...
!118 = !DILocation(line: 27, column: 4, scope: !107)
!119 = !DILocation(line: 18, column: 24, scope: !102)
!120 = !DILocation(line: 18, column: 4, scope: !102)
!121 = distinct !{!121, !105, !122}
!122 = !DILocation(line: 27, column: 4, scope: !99)
!123 = !DILocation(line: 29, column: 11, scope: !9)
!124 = !DILocation(line: 29, column: 4, scope: !9)
!125 = !DILocation(line: 30, column: 4, scope: !9)